...
| Name | Type | Purpose | Current Status |
| :--- | :--- | :--- | :--- |
| `ENGINE_OWNERSHIP_AND_DATA_CONTRACT_REGISTRY_v1.0.md` | Governance | Defines strict ownership and data contracts for engines. | Active |
| `GOVERNANCE_COMPLIANCE_CHECKLIST_v1.0.md` | Governance | Mandatory compliance checklist for future modifications. | Active |
| `GM-004_COMPLETION_REPORT_v1.0.md` | Governance | Formal completion report for the GM-004 milestone. | Active |
| `ASTROLOGICAL_PREDICTION_GOVERNANCE_v1.md` | Architecture | Overarching prediction rules. | Active |
...
| Name | Type | Purpose | Current Status |
| :--- | :--- | :--- | :--- |
| `FORMULA_CATEGORY_CATALOG_v1.md`, etc. | Catalog | Catalogs the astrological formulas and variants. | Active |
| `FORMULA_LIBRARY_REVIEW_PACK.md`, etc. | Planning | Plans and reviews the formula index structures. | Active |
...
* **Canonical**: 
  * `ENGINE_OWNERSHIP_AND_DATA_CONTRACT_REGISTRY_v1.0.md`
  * `GOVERNANCE_COMPLIANCE_CHECKLIST_v1.0.md`
  * `GOLDEN_MASTER_MANIFEST.md`
  * All active `KNOWLEDGE_PACKAGE` documents.
* **Supporting**: 
  * `FORMULA_CATEGORY_CATALOG_v1.md`
  * `QUESTION_COVERAGE_MATRIX_v1.md`
* **Reference**: 
  * `PROGRAM_A_COMPLETION_REPORT.md`
  * Final state architecture reviews (e.g., `PHASE14G_ARCHITECTURE_REVIEW.md`)
* **Legacy**: 
...
* **Archive Candidate**: 
  ...
  * Interim step reports and fixes (`PHASE9_STEP1_REPORT_PROFILE_FIX.md`)
* **Future**: 
...
* **Documents**: 
  * Multiple historical phase reports cover overlapping architecture (e.g., `PHASE14A_ARCHITECTURE_REPORT.md` vs. Knowledge Packages).
  * `DOCUMENTATION_INDEX_2026-06-19.md` vs. the new Master Inventory.
* **Rules & Architecture**: 
...
* **Definitions**: 
  * Question routing definitions exist in `QUESTION_ENGINE_KNOWLEDGE_PACKAGE.md` but are also scattered across various `PHASE11` and `PHASE14` implementation reports.
