...
| **Yoga Detection** | Yoga Engine | `FORMULA_MASTER_INDEX_PLAN.md` | Master Probability | `YOGA_INTELLIGENCE_KNOWLEDGE_PACKAGE.md` | Canonical | Active |
...
| **Dasha Activation** | Dasha Engine | `FORMULA_MASTER_INDEX_PLAN.md` | Master Probability | `DASHA_INTELLIGENCE_KNOWLEDGE_PACKAGE.md` | Canonical | Active |
