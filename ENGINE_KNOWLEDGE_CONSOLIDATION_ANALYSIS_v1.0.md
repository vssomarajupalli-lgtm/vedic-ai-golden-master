...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Planet Engine** | `PLANET_INTELLIGENCE_KNOWLEDGE_PACKAGE.md` | `ENGINE_OWNERSHIP_AND_DATA_CONTRACT_REGISTRY_v1.0.md` | House, Yoga, Varga, Dosha | Canonical | Active |
| **House Engine** | `HOUSE_INTELLIGENCE_KNOWLEDGE_PACKAGE.md` | `ENGINE_OWNERSHIP_AND_DATA_CONTRACT_REGISTRY_v1.0.md` | Yoga, Dosha, Varga | Canonical | Active |
| **Dasha Engine** | `DASHA_INTELLIGENCE_KNOWLEDGE_PACKAGE.md` | `ENGINE_OWNERSHIP_AND_DATA_CONTRACT_REGISTRY_v1.0.md` | Master Probability | Canonical | Active |
| **Yoga Engine** | `YOGA_INTELLIGENCE_KNOWLEDGE_PACKAGE.md` | `ENGINE_OWNERSHIP_AND_DATA_CONTRACT_REGISTRY_v1.0.md` | Master Probability | Canonical | Active |
| **Dosha Engine** | `DOSHA_INTELLIGENCE_KNOWLEDGE_PACKAGE.md` | `ENGINE_OWNERSHIP_AND_DATA_CONTRACT_REGISTRY_v1.0.md` | Master Probability | Canonical | Active |
| **Varga Engine** | `VARGA_INTELLIGENCE_KNOWLEDGE_PACKAGE.md` | `ENGINE_OWNERSHIP_AND_DATA_CONTRACT_REGISTRY_v1.0.md` | Dasha | Canonical | Active |
| **Functional Nature Engine** | `FUNCTIONAL_NATURE_ENGINE_KNOWLEDGE_PACKAGE.md` | `ENGINE_OWNERSHIP_AND_DATA_CONTRACT_REGISTRY_v1.0.md` | Master Probability | Canonical | Active |
| **Master Probability Engine** | `MASTER_PROBABILITY_KNOWLEDGE_PACKAGE.md` | `ENGINE_OWNERSHIP_AND_DATA_CONTRACT_REGISTRY_v1.0.md` | Question Engine | Canonical | Active |
| **Question Engine** | `QUESTION_ENGINE_KNOWLEDGE_PACKAGE.md` | `QUESTION_REGISTRY_MASTER_v1.md` | API Layer | Canonical | Active |
| **Quality Metrics Engine** | `QUALITY_METRICS_ENGINE_KNOWLEDGE_PACKAGE.md` | `DEPLOYMENT_VALIDATION_REPORT.md` | Pipeline Runner | Canonical | Active |
| **Mandali Generator** | `MANDALI_GENERATOR_KNOWLEDGE_PACKAGE.md` | `PHASE15_MANDALI_DECOUPLING_DECISION_RECORD.md` | Transit Engine | Canonical | Active |
| **Transit Engine** | `TRANSIT_ENGINE_KNOWLEDGE_PACKAGE.md` | None | None | Legacy | Legacy Reference |
| **Validation Framework** | `VALIDATION_FRAMEWORK_KNOWLEDGE_PACKAGE.md` | `DEPLOYMENT_VALIDATION_REPORT.md` | QA Systems | Canonical | Active |
| **Calibration Framework** | `CALIBRATION_FRAMEWORK_KNOWLEDGE_PACKAGE.md` | None | Master Probability | Canonical | Active |
| **Pipeline Runner** | None (Orchestration logic is fragmented) | `DEPENDENCY_AUDIT_REPORT.md` | Question Engine | Temporary / Needs Consolidation | Conflicted |
...
* **Yoga / Dosha Engines**:
  ...
  * *Dependent Documents*: `FORMULA_REPOSITORY_DATA_MODEL_v1.md`
...
* **Master Probability Engine**:
  ...
  * *Dependent Documents*: `QUESTION_ENGINE_KNOWLEDGE_PACKAGE.md`
...
* **Duplicate responsibilities**: Both `QUESTION_ENGINE_KNOWLEDGE_PACKAGE.md` and `MASTER_PROBABILITY_KNOWLEDGE_PACKAGE.md` describe Pipeline execution sequence. (*Classification: Requires Future Consolidation*)
* **Duplicate architectural explanations**: Found across `ASTROLOGICAL_PREDICTION_GOVERNANCE_v1.md` and `GOLDEN_MASTER_MANIFEST.md`. (*Classification: Requires Future Consolidation*)
* **Duplicate ownership**: The `FORMULA_REPOSITORY_DATA_MODEL_v1.md` re-defines Yoga boundaries. (*Classification: True Duplicate*)
...
* **Engine**: Pipeline Runner
  * **Conflicting Documents**: `QUESTION_ENGINE_KNOWLEDGE_PACKAGE.md` vs `MASTER_PROBABILITY_KNOWLEDGE_PACKAGE.md`
  ...
  * **Future Consolidation Recommendation**: Extract execution DAG logic into a new, canonical `PIPELINE_RUNNER_KNOWLEDGE_PACKAGE.md`.

* **Engine**: Question Engine
  * **Conflicting Documents**: `QUESTION_ENGINE_KNOWLEDGE_PACKAGE.md` vs System Architecture
