...
* **REF-BKL-005**: Recovered 16 hidden architectural constraints into formal Architecture Decision Records (ADR-001 through ADR-016), established the ARCHITECTURE_DECISION_LOG_v1.0.md, and completed the Final Constitutional Audit.
...
2. **Review Current State:** Read `REPOSITORY_REFINEMENT_DECISION_REGISTER_v1.0.md` to see the exact implemented changes (BKL-001 through BKL-005).
