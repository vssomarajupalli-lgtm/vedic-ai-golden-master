...
| **CON-004** | Yoga Formulas | `YOGA_INTELLIGENCE_KNOWLEDGE_PACKAGE.md` vs `FORMULA_REPOSITORY_DATA_MODEL_v1.md` | Formula Conflict | Both attempt to define the mathematical structure for Yogas. | Calculation drift | Affirm Knowledge Package as canonical; update Data Model to reference it | RESOLVED (REF-BKL-004) | Implemented |
