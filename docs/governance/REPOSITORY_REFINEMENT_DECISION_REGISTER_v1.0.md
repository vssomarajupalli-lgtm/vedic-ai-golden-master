...
* **Current Location**: Root directory
* **Proposed Action**: Merge into a single Canonical Governance document `docs/governance/FORMULA_GOVERNANCE_v1.0.md` and archive the original three documents to `docs/archive/formulas/`.
