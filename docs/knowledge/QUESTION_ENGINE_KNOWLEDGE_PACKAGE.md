...
## 4. Execution Flow
*(Execution DAG and sequence moved to `docs/knowledge/PIPELINE_RUNNER_KNOWLEDGE_PACKAGE.md`)*

## 5. Engine Dependency Diagram
*(Moved to `docs/knowledge/PIPELINE_RUNNER_KNOWLEDGE_PACKAGE.md`)*
...
- *(Probability synthesis logic is constitutionally owned by `docs/knowledge/MASTER_PROBABILITY_KNOWLEDGE_PACKAGE.md`. The Question Engine strictly routes probabilities calculated by the Master Probability Engine and performs no synthesis itself.)*
