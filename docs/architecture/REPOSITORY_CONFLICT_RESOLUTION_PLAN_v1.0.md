...
| **CON-004** | Yoga Formulas | `YOGA_INTELLIGENCE_KNOWLEDGE_PACKAGE.md` vs `docs/architecture/FORMULA_REPOSITORY_DATA_MODEL_v1.md` | Formula Conflict | Both attempt to define the mathematical structure for Yogas. | Calculation drift | Affirm Knowledge Package as canonical; update Data Model to reference it | RESOLVED (REF-BKL-004) | Implemented |
...
5. **Decision Register Entry**: Formally propose the resolution in the `docs/governance/REPOSITORY_REFINEMENT_DECISION_REGISTER_v1.0.md`.
