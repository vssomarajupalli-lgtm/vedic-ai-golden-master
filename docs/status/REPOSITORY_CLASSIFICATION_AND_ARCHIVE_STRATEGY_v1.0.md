...
| **Supporting** | Aids organization and coverage tracking. | Organizational | Writable as active development occurs. | Permanent while relevant. | `docs/status/FORMULA_CATEGORY_CATALOG_v1.md`, `docs/status/QUESTION_COVERAGE_MATRIX_v1.md` |
| **Reference** | Provides historical proof of work and audits. | Historical Context | Strictly Read-Only. Never modified. | Permanent. May be moved to `/docs/reference`. | `docs/architecture/PHASE14G_ARCHITECTURE_REVIEW.md`, `docs/status/PROGRAM_A_COMPLETION_REPORT.md` |
...
* Historical step-by-step implementation notes (e.g., `docs/status/PHASE9_STEP1_REPORT_PROFILE_FIX.md`)
...
* `docs/governance/ASTROLOGICAL_PREDICTION_GOVERNANCE_v1.md` → **Canonical**
* Historical draft (`docs/status/PHASE9_STEP1_REPORT_PROFILE_FIX.md`) → **Archive Candidate**
