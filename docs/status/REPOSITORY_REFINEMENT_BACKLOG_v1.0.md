...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **BKL-001** | Engine Knowledge | `docs/knowledge/QUESTION_ENGINE_KNOWLEDGE_PACKAGE.md` vs `docs/knowledge/MASTER_PROBABILITY_KNOWLEDGE_PACKAGE.md` | Conflict Resolution Plan | Critical | High | Pipeline Runner | High | REF-BKL-001 | Complete |
| **BKL-002** | Engine Knowledge | `docs/knowledge/QUESTION_ENGINE_KNOWLEDGE_PACKAGE.md` | Formula Ownership Mapping | Critical | High | API Layer | Medium | REF-BKL-002 | Complete |
...
| **BKL-004** | Formula Knowledge | `docs/architecture/FORMULA_REPOSITORY_DATA_MODEL_v1.md` | Formula Ownership Mapping | High | Medium | Yoga Engine | Low | REF-BKL-004 | Complete |
...
| **BKL-007** | Formula Knowledge | `docs/status/FORMULA_CATEGORY_CATALOG_v1.md`, `docs/status/FORMULA_FAMILY_CATALOG_v1.md` | Duplication Analysis | Low | Low | Engine references | Low | Pending | Queued |
