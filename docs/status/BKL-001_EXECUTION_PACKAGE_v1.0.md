...
* **Repository Asset(s)**: `docs/knowledge/QUESTION_ENGINE_KNOWLEDGE_PACKAGE.md` vs `docs/knowledge/MASTER_PROBABILITY_KNOWLEDGE_PACKAGE.md`
...
* **Conflict Resolution Plan**: Documented CON-001, identifying that both `docs/knowledge/QUESTION_ENGINE_KNOWLEDGE_PACKAGE.md` and `docs/knowledge/MASTER_PROBABILITY_KNOWLEDGE_PACKAGE.md` illegally claim to define the execution sequence of the `PipelineRunner`.
...
### In Scope
* Extraction of all pipeline execution and orchestration rules currently residing inside `docs/knowledge/QUESTION_ENGINE_KNOWLEDGE_PACKAGE.md` and `docs/knowledge/MASTER_PROBABILITY_KNOWLEDGE_PACKAGE.md`.
...
2. `docs/knowledge/QUESTION_ENGINE_KNOWLEDGE_PACKAGE.md` contains zero references to directing the `PipelineRunner`.
3. `docs/knowledge/MASTER_PROBABILITY_KNOWLEDGE_PACKAGE.md` contains zero references to directing the `PipelineRunner`.
4. The `docs/governance/REPOSITORY_REFINEMENT_DECISION_REGISTER_v1.0.md` contains an approved entry for BKL-001 detailing the exact line removals and file additions.
